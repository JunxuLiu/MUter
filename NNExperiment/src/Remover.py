...
import os
from utils import paramters_to_vector, total_param, cg_solve, get_cg_iters
...
class Remover:
    ...
    def Update_net_parameters(self, ):
        ...
        delta_w = cg_solve(self.matrix + damp_factor, self.grad, cg_iters=get_cg_iters(self.args))
...
class MUterRemover(Remover):
    ...
    we use the vmap, jaccre from functorch to do this.
    """
...
class FMuterRemover(MUterRemover):
    ...
    def __init__(self, basic_neter, dataer, isDelta, remove_method, args, mini_batch=128):
        ...
        super(FMuterRemover, self).__init__(basic_neter, dataer, isDelta, remove_method, args)
...
class SchurMUterRemover(MUterRemover):
    ...
    def __init__(self, basic_neter, dataer, isDelta, remove_method, args, mini_batch=128):
        ...
        super(SchurMUterRemover, self).__init__(basic_neter, dataer, isDelta, remove_method, args) 
    ...
    def Unlearning(self, head=-1, rear=-1, mini_batch=128):
        ...
        delta_w = cg_solve(block_matrix, grad_extension, cg_iters=get_cg_iters(self.args))
