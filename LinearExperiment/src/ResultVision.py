...
if __name__ == "__main__":
    ...
    ploter.cvpr_plot(save_name='Context_metrics_distance', metrics='distance', adv_type=1, datasetId=1)
    ploter.cvpr_plot(save_name='Context_metrics_acc', metrics='acc', adv_type=1, datasetId=1)
    ploter.cvpr_plot(save_name='Context_metrics_perturbed_acc', metrics='perturbed_acc', adv_type=1, datasetId=1)
